...
- AI often over-capitalizes headings indiscriminately. However, always prioritize the established house style or institutional guidelines. For this thesis project ([Project_Name]), **Title Case** is the mandatory standard for all heading levels. Avoid the automatic conversion to sentence case if a specific standard is already in place.
