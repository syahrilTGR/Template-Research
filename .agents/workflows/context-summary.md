...
2. Read `supportFiles/handoff.md` — note the current stage, what is already written, and what is currently being worked on.
...
4. Read `papers/index.md` to understand which source materials are indexed and available.
