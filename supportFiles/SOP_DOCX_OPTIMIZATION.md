...
```powershell
# Jalankan di PowerShell (Sesuaikan [User_Name] dengan nama user Windows Anda)
[System.Environment]::SetEnvironmentVariable("NODE_PATH", "C:\Users\[User_Name]\AppData\Roaming\npm\node_modules", "User")
```
