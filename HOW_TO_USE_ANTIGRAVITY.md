...
Pada versi **v1.1.1**, asisten AI Anda dapat berinteraksi secara langsung dengan akun Google NotebookLM Anda di cloud menggunakan protokol Model Context Protocol (MCP) tanpa perlu membuka browser secara manual.
